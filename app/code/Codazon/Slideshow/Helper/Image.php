...
class Image extends AbstractHelper
{
    ...
    {
        //if (!$this->_processor) {
            $filename = $this->_baseFile ? $this->_mediaDirectory->getAbsolutePath('codazon/slideshow/'.$this->_baseFile) : null;
    ...
    public function resize($width,$height = null)
    {
        if($this->_baseFile){
            ...
            $this->_height = $height;
            if(!$this->isCached()){
                $path = 'codazon/slideshow/cache/'.$width.'x'.$height;
